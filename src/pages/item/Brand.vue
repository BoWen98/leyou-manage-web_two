    ...
    >
      <template slot="items" slot-scope="props">
        ...
        <td class="justify-center layout px-0">
          ...
          <!--</v-btn>-->
          <v-btn color="info" @click="editBrand(props.item)" small>编辑</v-btn>
          <v-btn color="warning" @click="deleteBrand(props.item)" small>删除</v-btn>
        </td>
      </template>
    </v-data-table>
    <!--弹出的对话框-->
